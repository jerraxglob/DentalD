        ...
        <div class="row d-flex align-items-cente ">
            <div class="col-md-12 col-lg-12  gx-5    py-3 rounded-3  bg-white">
                <ul class="nav nav-tabs mb-3 " id="ex-with-icons" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a data-bs-toggle="tab" class="nav-link font-16" id="ex-with-icons-tab-2"
                            href="#ex-with-icons-tabs-2" role="tab" aria-controls="ex-with-icons-tabs-2 border"
                            aria-selected="false">
                            Draft consultation
                        </a>
                    </li>
...
"></i>
                                ...
                                <span class="pl-3 px-2">
                                    <div class="dropdown">
                                        <button
                                            class="btn btn-sm btn-white  border border-dark w-10 h-60 dropdown-toggle font-14"
