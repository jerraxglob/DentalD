...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const data = {
        ...
        datasets: [
            {
                label: "Income",
                data: [{x : 8000,y :4,indexLabel: "\u2605 Highest"}, {x : 7000,y :4,indexLabel: "\u2605 Highest"},{x : 5000,y :4,indexLabel: "\u2605 Highest"},{x : 8000,y :4,indexLabel: "\u2605 Highest"},{x : 6000,y :4,indexLabel: "\u2605 Highest"}],
