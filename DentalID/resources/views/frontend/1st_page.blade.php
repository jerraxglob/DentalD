                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <div class="row  justify-content-center align-items-center">
                                            ...
                                            <div class="col-md-6 col-lg-6 text-center ">
                                                <h6>Evelyn Thomas</h6>
                                                <span class="text-black text-center"> N°284740</span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Information patient -->
                                    <div class="col-lg-3 col-md-4 col-sm-12 text-center">
                                        <h6>Information patient.</h6>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-12 text-center">
                                        <h6>Prochain(s) rendez-vous.</h6>
                                        <span class="fs-6 bg-info text-nowrap p-0">
                        ...
                        <div class="card-body mt-4">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-8 col-lg-8">
                                    ...
                                    <b class="text-muted mt-2">Date</b><br>
                                    <b class="mt-2">Message</b>
                                    <p class="text-left text-black mt-2">
                                    ...
                                    <form action="">
                                        ...
                                        <div>
                                            <div class="d-grid  col-12  mx-auto  py-4 mb-2">
                                                <button class="btn btn-sm btn-primary px-5 " type="button">Envoyer
                                                </button>
                                            </div>
                                        </div>
